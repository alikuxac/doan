...
export class ReservationsRoomController {
  constructor(private readonly reservationsRoomService: ReservationsRoomService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateReservationsRoomDto: UpdateReservationsRoomDto) {
